...
const NEXOS_ES = {
  ...
  ventanas: {
    ...
    faq: {
      ...
      items: [{
        ...
        a: 'Cada donación aparece en el reporte con tu nombre, método de pago y monto. Puedes buscar tu nombre en nuestra página principal y encontrar tu aporte. El sistema se actualiza manualmente por lo que puede tomar algunos días.'
      }, {
        ...
        q: '¿En qué monedas puedo donar?',
        a: 'Recibimos USD, VES, ARS, EUR y USDT. En el reporte convertimos todo a USD para simplificar.'
      }, {
        q: '¿Puedo donar cosas y no dinero?',
        a: 'Sí, pero las necesidades van cambiando día a día por lo que no tenemos una lista fija de necesidades. Si quieres donar cosas ponte en contacto con nosotros por Instagram.'
      }]
    }
  },
  ficha: [{
  ...
  ui: {
    ...
    paso1t: 'Elige método',
    paso1: 'Haz click en <b style="color:var(--accent)">Donar ahora</b> y selecciona la forma de pago que prefieras.',
...
const NEXOS_EN = {
  ...
  ventanas: {
    ...
    faq: {
      ...
      items: [{
        ...
        a: 'Every donation appears in the report with your name, payment method and amount. You can search for your name on our main page and find your contribution. The system is updated manually, so it may take a few days.'
      }, {
        ...
        q: 'What currencies can I donate in?',
        a: 'We accept USD, VES, ARS, EUR and USDT. In the report we convert everything to USD to keep it simple.'
      }, {
        q: 'Can I donate goods instead of money?',
        a: 'Yes, but needs change day to day, so we do not have a fixed list of needs. If you want to donate goods, reach out to us on Instagram.'
      }]
    }
  },
  ficha: [{
  ...
  ui: {
    ...
    paso1: 'Click <b style="color:var(--accent)">Donate now</b> and select the payment method you prefer.',
...
// ui_kits/landing/export/EditorialLandingExport.jsx
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
const NS = window.NEXOSDesignSystem_0519e6;
const {
...
function EditorialLandingExport() {
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, u.donarAhora)), /*#__PURE__*/React.createElement(LightboxExport, {
    index: zoom,
    fotos: d.fotos,
    credito: d.credito,
    onClose: function () {
    ...
    onIndex: setZoom
  }), t.subventana === 'Página' ? /*#__PURE__*/React.createElement(SectionPageExport, {
    lang: lang,
    id: drawer,
    onClose: function () {
      setDrawer(null);
  ...
  }) : /*#__PURE__*/React.createElement(SectionWindowExport, {
    lang: lang,
    variant: t.winHeader === 'Coral' ? 'grafica' : 'editorial',
    id: drawer,
    onClose: function () {
...
Object.assign(window, {
  EditorialLandingExport
});
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/landing/export/EditorialLandingExport.jsx", error: String((e && e.message) || e) }); }

// ui_kits/landing/export/LightboxExport.jsx
try { (() => {
/* Visor de fotos a pantalla completa con navegación. */
function LightboxExport({
  index,
  fotos,
  credito,
  onClose,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/landing/export/LightboxExport.jsx", error: String((e && e.message) || e) }); }

// ui_kits/landing/export/SectionPageExport.jsx
try { (() => {
/* Sub-ventana alternativa: toma toda la pantalla y se lee como una página propia (una sola columna). */
const NSP = window.NEXOSDesignSystem_0519e6;
function SectionPageExport({
  id,
  onClose,
  onOpen,
  onDonate,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/landing/export/SectionPageExport.jsx", error: String((e && e.message) || e) }); }

// ui_kits/landing/export/SectionWindowExport.jsx
try { (() => {
/* Ventana centrada de 960px a dos columnas — compartida por ambas direcciones de landing. */
const NSW = window.NEXOSDesignSystem_0519e6;
function SectionWindowExport({
  id,
  onClose,
  onOpen,
  onDonate,
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/landing/export/SectionWindowExport.jsx", error: String((e && e.message) || e) }); }

// ui_kits/landing/export/content.js
try { (() => {
/* Contenido editorial de la landing, en ES y EN.
   Los textos de las secciones (Quiénes somos, Evidencia, Aliados, Preguntas) pueden
   sobreescribirse desde la hoja "Config" del Sheet: ver nexosContent() abajo. */
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/landing/export/content.js", error: String((e && e.message) || e) }); }

// ui_kits/landing/export/data-source.js
try { (() => {
/* Conector con el Apps Script de NEXOS.
   Pega aquí la URL del deployment (.../exec) y la página usa datos reales;
   si queda vacía, se muestran los datos de ejemplo de data.js.
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/landing/export/data-source.js", error: String((e && e.message) || e) }); }

// ui_kits/landing/export/image-slot.js
try { (() => {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/landing/export/image-slot.js", error: String((e && e.message) || e) }); }

// ui_kits/landing/export/tweaks-panel.jsx
try { (() => {
// @ds-adherence-ignore -- omelette starter scaffold (raw elements/hex/px by design)
// Copied omelette starter. Re-running copy_starter_component with this kind overwrites this file with the latest version (page content is unaffected).
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/landing/export/tweaks-panel.jsx", error: String((e && e.message) || e) }); }
